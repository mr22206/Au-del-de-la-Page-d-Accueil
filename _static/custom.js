...
document.addEventListener('DOMContentLoaded', () => {
    console.log('[DIAGNOSTIC] Le script custom.js est lancé.');
    ...
    const observer = new MutationObserver(() => {
        ...
        console.log(`[DIAGNOSTIC] ${mermaidContainers.length} diagramme(s) trouvé(s) !`);
    ...
    console.log('[DIAGNOSTIC] Démarrage de l\'observateur pour attendre les diagrammes...');
